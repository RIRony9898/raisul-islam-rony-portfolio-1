      ...
      <div className="container mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
        <div className="order-2 md:order-1 space-y-6">
          <h1 className="text-5xl md:text-7xl font-bold text-white leading-tight">
            Hi, I’m <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-600">Raisul Islam Rony</span>
          </h1>
          <h2 className="text-2xl md:text-3xl text-gray-300 font-semibold">
            Full Stack Developer
          </h2>
          <p className="text-gray-400 max-w-lg text-lg leading-relaxed">
            I build dynamic and responsive web applications using React, Node.js, Express, and MongoDB. I love turning ideas into powerful, user-friendly digital experiences.
          </p>
          
          <div className="flex gap-4 pt-2">
             {[Facebook, Github, Linkedin, Instagram].map((Icon, i) => (
                <a key={i} href="#" className="w-10 h-10 rounded-full border border-primary text-primary flex items-center justify-center hover:bg-primary hover:text-white transition-all duration-300">
                   <Icon size={20} />
                </a>
             ))}
          </div>
